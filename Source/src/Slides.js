    ...
    return (
        <div className='parent'>
            <div id="navigation" className="text-center">
                <button data-testid="button-restart" className="btn" onClick={() => onClickRestart()} disabled={disabledRestart}>Restart</button>
                <button data-testid="button-prev" className="btn disable" onClick={() => onClickPrev()} disabled={disabledPrev}>Prev</button>
                <button data-testid="button-next" className="btn disable" onClick={() => onClickNext()} disabled={disabledNext}>Next</button>
            </div>
